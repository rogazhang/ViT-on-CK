...
from model.conditional_pos_encoding import get_model

def get_training_args():
    output_dir = "./training_conditional_result"
...
def train_model():
    ...
    # 8. 保存模型
    print("保存相对位置编码ViT模型...")
    trainer.save_model("./training_conditional_result/vit_emotion_model_conditional")
...
if __name__ == "__main__":
    ...
    print("\n=== TensorBoard可视化指引 ===")
    print(f"1. 终端执行：tensorboard --logdir=./training_conditional_result/logs")
